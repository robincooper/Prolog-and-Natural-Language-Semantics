...
q(VP) --> whpron, vp(VP, []-[]).
q(X^(NP*VP)) --> whnp(NP, []-[wh(np,X)]),vp(VP, []-[]).
q(X^S) --> whpron, sinv(S, [gap(np,X)]-[]).
q(X^(NP*Y^S)) --> whnp(NP,[]-[wh(np,X)]), sinv(S, [gap(np,Y)]-[]).
q(yes^S) --> sinv(S,[]-[]).
...
whnp(P^(Rel*N*X & P*X), []-[wh(np,X)]) --> [which], n(N), optrel(Rel).
...
optrel(P^(X^(P*X&S))) --> relpron, s(S, [gap(np, X)]-[]).
